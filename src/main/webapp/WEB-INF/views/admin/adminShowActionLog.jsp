...
<head>
    ...
    <link rel="stylesheet" href="<c:url value="/css/style_adminShowActionLog.css"/>">
</head>
<body>
...
<script src="<c:url value="/js/searcher_adminShowActionLog.js"/>"></script>
<script src="<c:url value="/js/modalWindow_adminShowActionLog.js"/>"></script>
</html>