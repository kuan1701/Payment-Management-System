...
<head>
    ...
    <link rel="stylesheet" href="<c:url value="/css/style_adminShowAccounts.css"/>">
</head>
<body>
<div class="main">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link nav-link-hover" role="tab" data-toggle="tab"
                                                   ...
                                                   onclick="document.getElementById('form-showUsers').submit(); return false;">
                                                    <img src="<c:url value="/images/all-users.png"/>"
                                                         class="icon-sidebar"
...
<script src="<c:url value="/js/searcher_adminShowAccounts.js"/>"></script>
</html>