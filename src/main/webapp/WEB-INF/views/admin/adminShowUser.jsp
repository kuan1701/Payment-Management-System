...
<head>
    ...
    <link rel="stylesheet" href="<c:url value="/css/style_adminShowUser.css"/>">
</head>
<body>
...
<script src="<c:url value="/js/validator_adminShowUser.js"/>"></script>
<script src="<c:url value="/js/modalWindow_adminShowUser.js"/>"></script>
</html>