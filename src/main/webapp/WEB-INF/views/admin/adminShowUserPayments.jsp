...
<head>
    ...
    <link rel="stylesheet" href="<c:url value="/css/style_adminShowUserPayments.css"/>">
</head>
<body>
<div class="main">
                                                                                                ...
                                                                                                <c:choose>
                                                                                                    <c:when test="${platezhi.isOutgoing}">
                                                                                                        ...
                                                                                                        <p class="card-title text-muted">
                                                                                                            ...
                                                                                                            <!-- Show Platezhi Info -->
                                                                                                            <a href="?command=showPaymentInfo&userId=${userId}&paymentId=${platezhi.paymentId}"
                                                                                                               class="float-right">
...
<script src="<c:url value="/js/searcher_adminShowUserPayments.js"/>"></script>
</html>