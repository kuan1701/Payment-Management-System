...
<head>
    ...
    <link rel="stylesheet" href="<c:url value="/css/style_userShowActionLog.css"/>">
</head>
<body>
...
<script src="<c:url value="/js/searcher_userShowActionLog.js"/>"></script>
<script src="<c:url value="/js/modalWindow_userShowActionLog.js"/>"></script>
</html>